...
// const lastBlock = myBlockchain.getBlockByHash();
// // console.log(lastBlock);

// const testBlock = myBlockchain.getBlock(lastBlock.hash);

// // console.log("TEST BLOCK", testBlock)

// const firstNewBlock = myBlockchain.chain[1];

// const isValid = myBlockchain.validateBlock(firstNewBlock);

// console.log(`The Block is${isValid ? '' : "n't"} valid!`);
